...
{
	public const int WindowPriority = 5000;
	public const int ModePriority = 4000;
	public const int FunctionPriority = 3000;
	...
	public static Color DefaultBackgroundColor
	{
		get
		{
			if (defaultBackgroundColor.a == 0)
			{
				...
				defaultBackgroundColor = (Color)method.Invoke(null, null);
			}
